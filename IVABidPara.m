function [ P_max, P_min, P_set, SOA_1 ] = IVABidPara(priceRecord, T_0, T_out, T_max, T_min, R, C, PN, Pmin, p1, p2, q1, q2, T)
...
fun = @(x) x' * (diag(a * ones(1, N), 0) + diag(b * ones(1, N - 1), 1)) * p1 / q1 * priceRecord + priceRecord' * (x - 0.5).^2 * (QN - Qmin);
%priceRecord' * (x - 0.5).^2 * (Q_max - Q_min); %beta 1-10 10-热 1-冷
% A2_main矩阵
% A 0 0 ... 0 0
% B A 0 ... 0 0
%..............
