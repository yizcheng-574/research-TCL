...
for t_index = 1: 24
    if t_index <= 7 || t_index > 21
        gridPriceRecord(t_index) = 1.1;
    elseif t_index >= 10 && t_index <= 17
        gridPriceRecord(t_index) = 0.8;
    else
        gridPriceRecord(t_index) = 0.5;
    end
end
for t_index = 1: I
...
sigmaRecord = gridPriceRecord4 * 0.5;
