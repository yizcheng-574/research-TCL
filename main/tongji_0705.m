...
drawPower(macPath, '/modePD', 'Case II(uncoordinated)', t, t2, c1, c2, c3, c4, '-', 4)
drawPower(macPath, subPath3, 'Case III(EV only)', t, t2, c1, c2, c3, c4, '-', 2)
drawPower(macPath,'/modeTCL', 'Case IV(EV & HVAC)', t, t2, c1, c2, c3, c4, '-', 3)
xlabel('t(day)')
% ----------------------------------------------------------------------
figure;
...
en = I_day * 5;
t3 = (st : en) * T - T;
Ht = stairs(t3, tielineRecord(st : en) / 1000, 'color', c1, 'LineWidth', 1, 'LineStyle', '-', 'marker', 'none');
Hev = stairs(t3, EV_totalpowerRecord(st : en) / 1000, 'color', c2, 'LineWidth', 1, 'LineStyle', '-', 'marker', 'none');
Htcl = stairs(t3, (TCL_totalpowerRecord(st : en) + IVA_totalpowerRecord(st : en)) / 1000, 'color', c3, 'LineWidth', 1, 'LineStyle', '-', 'marker', 'none');
load([macPath, '/modePD'], ...
    'tielineRecord', 'EV_totalpowerRecord', 'TCL_totalpowerRecord', 'IVA_totalpowerRecord', 'tielineBuy', 'DAY', 'T', 'I');
...
xticklabels({ '0', '12:00', '1', '12:00', '2', '12:00', '3', '12:00', '4', '12:00', '5', '12:00', '6', '12:00', '7'});
% set(gca,'xticklabel','');
le = legend([h1, h2, h3, h4],'Case I','Case II', 'Case III', 'Case IV', 'Orientation', 'horizontal');
 set(le ,'Box', 'off');
